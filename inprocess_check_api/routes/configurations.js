...
router.delete('/configurations/:id', configurationsController.deleteConfiguration);

// DELETE /api/configurations - Delete all configurations
router.delete('/configurations', configurationsController.deleteAllConfigurations);
