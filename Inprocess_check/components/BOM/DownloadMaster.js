      ...
      <div className="content-area">
        <div className="options-grid">
          ...
          <button
            ...
            onClick={() => navigation.navigate("bomdatewisedownload", { appType })}
          >
          ...
          <button
            ...
            onClick={() =>
              navigation.navigate("bomshiftwisedownload", { appType })
            }
          >
            <div className="option-icon">🕐</div>
            <div className="option-content">
          ...
          <button
            ...
            onClick={() =>
              navigation.navigate("bomparameterwisedownload", { appType })
            }
          >
            <div className="option-icon">📊</div>
            <div className="option-content">
          ...
          <button
            ...
            onClick={() => navigation.navigate("bomdownloadscreen", { appType })}
          >
